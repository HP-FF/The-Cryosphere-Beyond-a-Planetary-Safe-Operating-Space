...
if __name__ == "__main__":
    excel_folder = "../../draw_data/permafrost/Area"
    ...
    for expath in ex_folder:
        ...
        if os.path.basename(expath).split('_')[1].split('.')[0] == 'CESM2':
            ...
            if color_index == 0:
                ...
                ax.xaxis.set_major_formatter(ticker.FuncFormatter(formatter))  # 应用反向变换显示年份

                ax.xaxis.set_major_locator(
                    ticker.FixedLocator([bias, bias + 25, bias + 50, bias + 67.5, bias + 85]))  # 刻度线
    ...
    plt.show()
    # out_path = "./Extended Data Fig 3b.svg"
